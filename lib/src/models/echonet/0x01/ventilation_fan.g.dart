...
part of 'ventilation_fan.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

VentilationFan _$VentilationFanFromJson(Map<String, dynamic> json) =>
    VentilationFan(
      ...
      automaticVentilationOperation:
          json['automaticVentilationOperation'] as bool?,
    );

Map<String, dynamic> _$VentilationFanToJson(VentilationFan instance) {
  ...
  val['automaticVentilationOperation'] = instance.automaticVentilationOperation;
  return val;
}
