...
GasMeter _$GasMeterFromJson(Map<String, dynamic> json) => GasMeter(
      ...
      cumulativeGasConsumptionLog:
          json['cumulativeGasConsumptionLog'] as List<dynamic>?,
    );

Map<String, dynamic> _$GasMeterToJson(GasMeter instance) {
  ...
  val['cumulativeGasConsumptionLog'] = instance.cumulativeGasConsumptionLog;
  return val;
}
