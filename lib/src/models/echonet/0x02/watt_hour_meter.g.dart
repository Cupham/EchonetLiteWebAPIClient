...
part of 'watt_hour_meter.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

WattHourMeter _$WattHourMeterFromJson(Map<String, dynamic> json) =>
    WattHourMeter(
      ...
      cumulativeElectricEnergyLog1:
          json['cumulativeElectricEnergyLog1'] as List<dynamic>?,
    );

Map<String, dynamic> _$WattHourMeterToJson(WattHourMeter instance) {
  ...
  val['cumulativeElectricEnergyLog1'] = instance.cumulativeElectricEnergyLog1;
  return val;
}
