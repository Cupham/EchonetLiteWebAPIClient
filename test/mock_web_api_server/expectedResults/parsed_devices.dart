...
class DeviceLoadedWithAllProperties {
  ...
  static void getWasherDryer(WasherDryer? d) {
    ...
    expect(d?.washerDryerCycleOptions1?[6],
        WasherDryerCycleEnum.washLightlySoiled);
    ...
    expect(d?.washerDryerCycleOptions2?[2],
        WasherDryerCycleEnum.washDrySmallAmountQuick);
    expect(
        d?.washerDryerCycleOptions2?[3], WasherDryerCycleEnum.washDryDrymark);
  ...
  static void getStorageBattery(StorageBattery? d) {
    ...
    expect(d?.minimumAndMaximumDischargingCurrentAtIndependent.runtimeType,
        MinAndMaxValue);
    expect(
        d?.minimumAndMaximumDischargingCurrentAtIndependent?.minValue, 386.9);
    expect(
  ...
  static void getSmartElectricEnergySubMeter(SmartElectricEnergySubMeter? d) {
    ...
    expect(
        d?.normalDirectionCumulativeElectricEnergyLog?.electricEnergy?.length,
        76);
    expect(
    ...
    expect(d?.normalDirectionCumulativeElectricEnergyLog?.electricEnergy?[59],
        100);
    expect(
    ...
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[11],
        66);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[12],
        58);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[13],
        68);
    ...
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[16],
        "noData");
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[17],
        66);
    ...
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[21],
        88);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[22],
        69);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[23],
        69);
    ...
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[46],
        "noData");
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[47],
        14);
    ...
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[51],
        "noData");
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[52],
        50);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[53],
        70);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[54],
        83);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[55],
        35);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[56],
        76);
  ...
  static void getPowerDistributionBoardMetering(
    ...
    expect(
        d?.cumulativeElectricEnergyListSimplex?.electricEnergy?[1], "noData");
    expect(
        d?.cumulativeElectricEnergyListSimplex?.electricEnergy?[2], "noData");
    expect(
        d?.cumulativeElectricEnergyListSimplex?.electricEnergy?[3], "noData");
    expect(
        d?.cumulativeElectricEnergyListSimplex?.electricEnergy?[4], "noData");
    expect(
        d?.cumulativeElectricEnergyListSimplex?.electricEnergy?[5], "noData");
    expect(d?.cumulativeElectricEnergyListSimplex?.electricEnergy?[6], 15);
    expect(
        d?.cumulativeElectricEnergyListSimplex?.electricEnergy?[7], "noData");
    expect(
        d?.cumulativeElectricEnergyListSimplex?.electricEnergy?[8], "noData");
    expect(
        d?.cumulativeElectricEnergyListSimplex?.electricEnergy?[9], "noData");
    ...
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?.length, 11);
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[0]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[0]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[1]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[1]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[2]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[2]?.tPhase,
        1546.0);
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[3]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[3]?.tPhase,
        -2300.4);
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[4]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[4]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[5]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[5]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[6]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[6]?.tPhase,
        685.5);
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[7]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[7]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[8]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[8]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[9]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(
        ...
        ElectricCurrent);
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[10]?.rPhase,
        541.4);
    expect(
        d?.instantaneousCurrentListSimplex?.instantaneousCurrent?[10]?.tPhase,
        "noData");
    expect(d?.instantaneousElectricPowerListSimplex.runtimeType,
        ElectricPowerList);
    ...
    expect(
        d?.instantaneousElectricPowerListSimplex
            ?.instantaneousElectricPower?[0],
        "noData");
    expect(
        d?.instantaneousElectricPowerListSimplex
            ?.instantaneousElectricPower?[1],
        -464324539);
    expect(
        d?.instantaneousElectricPowerListSimplex
            ?.instantaneousElectricPower?[2],
        1934033158);
    expect(
        d?.instantaneousElectricPowerListSimplex
    ...
    expect(
        d?.instantaneousElectricPowerListSimplex
            ?.instantaneousElectricPower?[4],
        "noData");
    expect(
        d?.instantaneousElectricPowerListSimplex
            ?.instantaneousElectricPower?[5],
        1206953687);
    expect(
        d?.instantaneousElectricPowerListSimplex
            ?.instantaneousElectricPower?[6],
        "noData");
    expect(
        d?.instantaneousElectricPowerListSimplex
            ?.instantaneousElectricPower?[7],
        "noData");
    expect(
        d?.instantaneousElectricPowerListSimplex
            ?.instantaneousElectricPower?[8],
        "noData");
    expect(
        d?.instantaneousElectricPowerListSimplex
            ?.instantaneousElectricPower?[9],
        -1337055581);
    expect(
        d?.instantaneousElectricPowerListSimplex
    ...
    expect(
        d?.cumulativeElectricEnergyListDuplex?.electricEnergy?[0].runtimeType,
    ...
    expect(
        ...
        "noData");
    expect(
        d?.cumulativeElectricEnergyListDuplex?.electricEnergy?[1].runtimeType,
        ElectricEnergyDuplex);
    expect(
    ...
    expect(
        ...
        "noData");
    expect(
        d?.cumulativeElectricEnergyListDuplex?.electricEnergy?[2].runtimeType,
        ElectricEnergyDuplex);
    expect(
    ...
    expect(
        ...
        20);
    expect(
        d?.cumulativeElectricEnergyListDuplex?.electricEnergy?[3].runtimeType,
        ElectricEnergyDuplex);
    expect(
    ...
    expect(
        ...
        56);
    expect(
        d?.cumulativeElectricEnergyListDuplex?.electricEnergy?[4].runtimeType,
        ElectricEnergyDuplex);
    expect(
    ...
    expect(
        ...
        "noData");
    expect(
        d?.cumulativeElectricEnergyListDuplex?.electricEnergy?[5].runtimeType,
        ElectricEnergyDuplex);
    expect(
    ...
    expect(
        ...
        "noData");
    expect(
        d?.cumulativeElectricEnergyListDuplex?.electricEnergy?[6].runtimeType,
        ElectricEnergyDuplex);
    expect(
    ...
    expect(
        ...
        95);
    expect(
        d?.cumulativeElectricEnergyListDuplex?.electricEnergy?[7].runtimeType,
        ElectricEnergyDuplex);
    expect(
    ...
    expect(
        ...
        "noData");
    expect(
        d?.cumulativeElectricEnergyListDuplex?.electricEnergy?[8].runtimeType,
        ElectricEnergyDuplex);
    expect(
    ...
    expect(
        ...
        51);
    expect(
        d?.cumulativeElectricEnergyListDuplex?.electricEnergy?[9].runtimeType,
        ElectricEnergyDuplex);
    expect(
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[9]?.tPhase,
        -1302.1);
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[10]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[10]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[11]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[11]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[12]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[12]?.tPhase,
        1846.7);
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[13]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[13]?.tPhase,
        -1021.1);
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[14]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[14]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[15]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[15]?.tPhase,
        1308.9);
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[16]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[16]?.tPhase,
        -2200.0);
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[17]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[17]?.tPhase,
        1784.7);
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[18]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[18]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[19]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[19]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[20]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[20]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[21]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[21]?.tPhase,
        1044.8);
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[22]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[22]?.tPhase,
        -864.8);
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[23]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[23]?.tPhase,
        3265.2);
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[24]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[24]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[25]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[25]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[26]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[26]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[27]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[27]?.tPhase,
        -784.4);
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[28]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[28]?.tPhase,
        1561.5);
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[29]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[29]?.tPhase,
        "noData");
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[30]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[30]?.tPhase,
        1233.4);
    expect(
        d?.instantaneousCurrentListDuplex?.instantaneousCurrent?[31]
            .runtimeType,
        ElectricCurrent);
    ...
    expect(
        ...
        "noData");
    expect(
        d?.instantaneousElectricPowerListDuplex
            ?.instantaneousElectricPower?[10],
        -891507052);
    expect(
        d?.instantaneousElectricPowerListDuplex
    ...
    expect(
        ...
        80);
    expect(
        d?.normalDirectionCumulativeElectricEnergyLog?.electricEnergy?[0], 3);
    expect(d?.normalDirectionCumulativeElectricEnergyLog?.electricEnergy?[1],
        "noData");
    expect(
    ...
    expect(d?.reverseDirectionCumulativeElectricEnergyLog?.electricEnergy?[5],
        100);
    expect(
  ...
  static void getLvSmartElectricEnergyMeter(LvSmartElectricEnergyMeter? d) {
    ...
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[13],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[14],
        70);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[15],
        28);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[16],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[17],
        53);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[18],
        85);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[19],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[20],
        68);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[21],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[22],
        70);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[23],
        49);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[24],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[25],
        35);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[26],
        87);
    ...
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[30],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[31],
        48);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[32],
        70);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[33],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[34],
        29);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[35],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[36],
        59);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[37],
        85);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[38],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[39],
        35);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[40],
        41);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[41],
        71);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[42],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[43],
        39);
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[44],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[45],
        78);
    ...
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[47],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[48],
        58);
    ...
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[52],
        "noData");
    expect(d?.normalDirectionCumulativeElectricEnergyLog1?.electricEnergy?[53],
        28);
    ...
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1.runtimeType,
        ElectricEnergyLog);
    expect(
        d?.reverseDirectionCumulativeElectricEnergyLog1?.day, "defaultValue");
    expect(
    ...
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[0],
        "noData");
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[1],
        55);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[2],
        "noData");
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[3],
        32);
    expect(
        d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[4], 1);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[5],
        12);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[6],
        18);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[7],
        27);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[8],
        36);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[9],
        "noData");
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[10],
        9);
    ...
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[35],
        90);
    expect(d?.reverseDirectionCumulativeElectricEnergyLog1?.electricEnergy?[36],
        8);
  ...
  static void getHybridWaterHeater(HybridWaterHeater? d) {
    ...
    expect(
        d?.solarPowerGenerationsUtilizationTime.runtimeType, StartAndEndTime);
  ...
  static void getHvSmartElectricEnergyMeter(HvSmartElectricEnergyMeter? d) {
    ...
    expect(d?.cumulativeReactiveElectricEnergy.runtimeType,
    ...
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[12],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[13],
        23);
    ...
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[15],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[16],
        77);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[17],
        97);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[18],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[19],
        66);
    ...
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[22],
        60);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[23],
        13);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[24],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[25],
        81);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[26],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[27],
        86);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[28],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[29],
        11);
    ...
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[31],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[32],
        28);
    ...
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[35],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[36],
        23);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[37],
        31);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[38],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[39],
        72);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[40],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[41],
        68);
    ...
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[45],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[46],
        41);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[47],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[48],
        56);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[49],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[50],
        59);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[51],
        21);
    ...
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[53],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[54],
        56);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[55],
        54);
    ...
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[58],
        44);
    ...
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[63],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[64],
        26);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[65],
        68);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[66],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[67],
        54);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[68],
        24);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[69],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[70],
        50);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[71],
        66);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[72],
        40);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[73],
        22);
    ...
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[75],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[76],
        96);
    ...
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[80],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[81],
        39);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[82],
        90);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[83],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[84],
        13);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[85],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[86],
        56);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[87],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[88],
        26);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[89],
        36);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[90],
        34);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[91],
        "noData");
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[92],
        16);
    expect(d?.cumulativeReactiveElectricEnergyLog?.reactiveElectricEnergy?[93],
        92);
    ...
    expect(d?.cumulativeActiveElectricEnergyAtEvery30Min?.activeElectricEnergy,
        88);
    ...
    expect(
        d?.cumulativeActiveElectricEnergyForPowerFactor?.activeElectricEnergy,
        15);
  ...
  static void getGeneralLighting(GeneralLighting? d) {
    ...
    expect(
        d?.maximumSettableLevelForNightLighting?.lightLevel, "notLightLevel");
  ...
  static void getFloorHeater(FloorHeater? d) {
    ...
    expect(d?.workedDailyTimer1?[0]?.startTime,
        DateFormat.Hms().parse("00:01:58"));
    expect(
        d?.workedDailyTimer1?[0]?.endTime, DateFormat.Hms().parse("12:12:15"));
    expect(d?.workedDailyTimer1?[1].runtimeType, StartAndEndTime);
    expect(d?.workedDailyTimer1?[1]?.startTime,
        DateFormat.Hms().parse("19:38:56"));
    expect(
    ...
    expect(d?.workedDailyTimer2?[0]?.startTime,
        DateFormat.Hms().parse("00:49:33"));
    expect(
  ...
  static void getElectricWaterHeater(ElectricWaterHeater? d) {
    ...
    expect(
        d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[0], -220860);
    expect(
        d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[1], -298750);
    expect(
        d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[2], -111220);
    expect(
    ...
    expect(
        d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[10], -54680);
    expect(
        d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[11], 192610);
    expect(d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[12],
        "invalid");
    expect(d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[13],
        "invalid");
    expect(
        d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[14], 324610);
    expect(d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[15],
        "invalid");
    expect(d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[16],
        "invalid");
    expect(d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[17],
        "invalid");
    expect(d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[18],
        "invalid");
    expect(d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[19],
        "invalid");
    expect(
        d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[20], -314390);
    expect(d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[21],
        "invalid");
    expect(d?.surplusPowerPrediction?.surplusEnergyPredictionValue?[22],
        "invalid");
    expect(
  ...
  static void getCookingHeater(CookingHeater? d) {
    ...
    expect(
        d?.heatingPower?.leftStove?.stateOfFlame, StateOfFlameEnum.noSetting);
    expect(
  ...
  static void getController(Controller? d) {
    ...
    expect(d?.deviceList?[1]?.connection,
        DeviceConnectionStatusEnum.notRegistered);
  ...
  static void getColdOrHotWaterHeatSourceEquipment(
    ...
    expect(d?.manufacturer.descriptions.runtimeType, JaEnStatement);
    expect(d?.manufacturer.descriptions?.ja,
        "中部電力パワーグリッド株式会社 2020/4/24 中部電力㈱より移管");
    expect(d?.manufacturer.descriptions?.en,
